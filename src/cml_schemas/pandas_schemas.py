...
SOURCE_SCHEMA = PandasSchema([
    PandasField("numerator_source_name",      "object",         nullable=False),
    PandasField("numerator_project_id",       "object",         nullable=True),
    PandasField("numerator_source_platform",  "object",         nullable=True),
    PandasField("denominator_source_name",    "object",         nullable=False),
    PandasField("denominator_project_id",     "object",         nullable=True),
    PandasField("denominator_source_platform","object",         nullable=True),
...
METADATA_SCHEMA = PandasSchema([
    ...
    PandasField("metric_state",                                 "object",         nullable=False),
