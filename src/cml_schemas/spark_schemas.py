...
SOURCE_SCHEMA = StructType([
    StructField("numerator_source_name",      StringType(),    nullable=False),
    StructField("numerator_project_id",       StringType(),    nullable=True),
    StructField("numerator_source_platform",  StringType(),    nullable=True),
    StructField("denominator_source_name",    StringType(),    nullable=False),
    StructField("denominator_project_id",     StringType(),    nullable=True),
    StructField("denominator_source_platform",StringType(),    nullable=True),
...
METADATA_SCHEMA = StructType(
    [
        ...
        StructField("metric_state",                                 StringType(),    nullable=False),
